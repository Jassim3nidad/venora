...
| `rsvp-notifications`    | Customer bearer for invitations; anon bearer + reminder secret for batches | Invitation guest UUID or bounded reminder mode                                                          | Sends SMTP RSVP mail and records delivery/error timestamps                                             | Ownership RLS; conditional reminder claim prevents duplicates                     |
