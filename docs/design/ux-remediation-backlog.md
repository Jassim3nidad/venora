...
|     5 | UX-05/08/09 landmark and heading structure | Marketing, marketplace, forgot-password | One main and one h1 per tested page; no nested complementary filter regions; axe/landmark assertions pass                        |
...
|     7 | UX-06 mobile drawer behavior               | Public and enterprise shells            | Named modal drawer contains focus, closes with Escape, makes background inert, and restores trigger focus                        |
