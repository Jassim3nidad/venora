...
| Admin governance            | Review action bar, tables, filters, details, settings                 | Permission-guarded admin actions                                                            | users, roles, permissions, applications, bookings, commissions, logs | Page-local empty/errors; disputes placeholder             | Tables/dialogs and destructive feedback source-only                     |
