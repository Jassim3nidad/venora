...
| `/account/timeline`           | `apps/web/app/(customer)/account/timeline/page.tsx`           | Event timeline planner        | Authenticated customer                             | U      | Source-only       |
...
- `apps/web/app/(customer)/account/timeline/page.tsx`
