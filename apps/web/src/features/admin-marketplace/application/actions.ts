...
import { createMarketplaceFlagSchema, updateMarketplaceFlagSchema } from "../schemas/marketplace-flag.schema";

export async function createMarketplaceFlagAction(rawInput: unknown) {
  return createServerAction(createMarketplaceFlagSchema, async (input) => {
...
export async function updateMarketplaceFlagAction(rawInput: unknown) {
  return createServerAction(updateMarketplaceFlagSchema, async (input) => {
    await requirePermission("marketplace.moderate");
