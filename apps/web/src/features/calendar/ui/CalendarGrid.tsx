...
import { eachDayOfInterval, startOfWeek, endOfWeek, startOfMonth, endOfMonth, parseISO } from "date-fns";
  ...
  return (
    <div className={`relative ${isUpdating ? "opacity-50 pointer-events-none" : ""}`}>
      ...
      <div className="grid grid-cols-7 gap-1 mb-2">
        {DAYS_OF_WEEK.map((d) => (
          <div key={d} className="text-center py-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
            {d}
          </div>
        ))}
      </div>
