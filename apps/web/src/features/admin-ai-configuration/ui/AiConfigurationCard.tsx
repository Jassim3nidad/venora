...
} from "../schemas/ai-configuration.schema";
    ...
    <div className="rounded-2xl border border-[#e5e7eb] bg-white">
      ...
      >
        <div>
          <p className="font-bold text-[#111827]">
            {AI_FEATURE_LABELS[config.feature]}
          </p>
      ...
      {expanded ? (
        <form
          ...
          className="space-y-4 border-t border-[#f1f5f9] p-5"
        >
          <div className="flex items-center gap-2">
            <input
              id={`${config.feature}-enabled`}
              type="checkbox"
              {...register("enabled")}
              className="h-4 w-4 rounded border-[#dbe3ef]"
            />
            <label
              htmlFor={`${config.feature}-enabled`}
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input {...register("model")} readOnly className={inputClass} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            <input
              id={`${config.feature}-moderation`}
              type="checkbox"
              {...register("moderationEnabled")}
              className="h-4 w-4 rounded border-[#dbe3ef]"
            />
            <label
              htmlFor={`${config.feature}-moderation`}
              className="text-sm font-semibold text-[#111827]"
            >
              Moderation enabled
            </label>
