                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {ownerVenues.map((venue) => {
                      ...
                      const wasAlready = currentPartnerVenueIds.includes(
                        venue.id,
                      );
                      return (
                        <label
                ...
                <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 transition hover:bg-amber-100">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-amber-700">
                      Preferred suppliers appear first in recommendations shown
                      to clients during event planning.
                    </p>
                  </div>
                </label>
