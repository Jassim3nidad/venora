...
const labelClass =
  "mb-1.5 block text-xs font-bold uppercase tracking-wide text-[#64748b]";
...
export function CreateCommissionRuleForm({
  ...
  return (
    <form
      ...
      className="space-y-4 rounded-2xl border border-[#e5e7eb] bg-[#f8fafc] p-5"
    >
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {scope === "venue" ? (
          <div>
            ...
            <input
              id="referenceId"
              {...register("referenceId")}
              placeholder="Paste the venue's UUID"
              className={inputClass}
            />
            <p className="mt-1 text-xs text-[#6b7280]">
              Find this in the venue's review page URL.
            </p>
            {errors.referenceId ? (
              <p className="mt-1 text-xs text-red-700">
                {errors.referenceId.message}
        ...
        <div>
          <label htmlFor="flatFee" className={labelClass}>
            Flat fee (₱)
          </label>
          <input
            id="flatFee"
        ...
        {errors.percentage ? (
          <p className="text-xs text-red-700 sm:col-span-2 lg:col-span-3">
            {errors.percentage.message}
          </p>
        ) : null}

        <div>
          <label htmlFor="minCommissionAmount" className={labelClass}>
            Minimum commission (₱)
          </label>
          <input
        ...
        <div>
          <label htmlFor="maxCommissionAmount" className={labelClass}>
            Maximum commission (₱)
          </label>
          <input
        ...
        <div>
          <label htmlFor="effectiveFrom" className={labelClass}>
            Effective from
          </label>
          <input
            id="effectiveFrom"
        ...
        <div>
          <label htmlFor="effectiveTo" className={labelClass}>
            Effective to{" "}
            <span className="font-normal normal-case text-[#6b7280]">
              (optional)
            </span>
      ...
      <div className="flex justify-end gap-2 border-t border-[#e5e7eb] pt-4">
        <button
          ...
          className="rounded-lg px-4 py-2 text-sm font-bold text-[#4b5563] hover:bg-white"
        >
          Cancel
        </button>
        <button
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Description className="sr-only">
            Edit the percentage, flat fee, and effective dates for this
            commission rule.
          </Dialog.Description>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
                <label htmlFor="edit-label" className={labelClass}>
                  Label
                </label>
                <input
                  id="edit-label"
              ...
              <div>
                <label htmlFor="edit-percentage" className={labelClass}>
                  Percentage
                </label>
                <input
                  id="edit-percentage"
              ...
              <div>
                <label htmlFor="edit-flatFee" className={labelClass}>
                  Flat fee (₱)
                </label>
                <input
                  id="edit-flatFee"
              ...
              <div>
                <label htmlFor="edit-from" className={labelClass}>
                  Effective from
                </label>
                <input
                  id="edit-from"
              ...
              <div>
                <label htmlFor="edit-to" className={labelClass}>
                  Effective to
                </label>
                <input
                  id="edit-to"
            ...
            <div className="flex justify-end gap-2 border-t border-slate-100 pt-4">
              <Dialog.Close asChild>
                <button
                  type="button"
                  disabled={isSubmitting}
                  className="rounded-lg px-4 py-2 text-sm font-bold text-[#4b5563] hover:bg-slate-100 disabled:opacity-50"
                >
                  Cancel
                </button>
              </Dialog.Close>
