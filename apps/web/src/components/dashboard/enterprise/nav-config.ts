...
export const NAV_BY_ROLE: Record<EnterpriseRole, NavItem[]> = {
  ...
  admin: [
    ...
    { label: "Bookings", href: "/admin/bookings", icon: "calendar_month", permission: "marketplace.view" },
    { label: "Inquiries", href: "/admin/inquiries", icon: "mail", permission: "marketplace.view" },
    ...
    { label: "Disputes", href: "/admin/disputes", icon: "gavel", permission: "reports.view" },
