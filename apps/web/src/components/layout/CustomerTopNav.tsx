        ...
        <div className="ml-auto flex min-w-0 items-center justify-end gap-1.5 sm:gap-3">
          ...
          <div className="relative z-50">
            ...
            {menuOpen ? (
              <div
                role="menu"
                className="absolute right-0 mt-2 w-64 overflow-hidden rounded-2xl border border-[#E5E7EB] bg-white p-2 shadow-xl shadow-slate-200/70"
              >
                <div className="grid gap-1 md:hidden">
                  {navLinks.map((item) => (
                    <Link
                      ...
                      role="menuitem"
                      onClick={closeMenu}
                      className="rounded-xl px-3 py-2 text-sm font-bold text-[#6B7280] transition hover:bg-[#EFF6FF] hover:text-[#2563EB]"
                    >
                      {item.label}
                    </Link>
                  ))}
                ...
                <div className="my-2 h-px bg-[#E5E7EB] md:mt-0" />

                <Link
                  href="/account"
                  role="menuitem"
                  onClick={closeMenu}
                  className="flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-bold text-[#111827] transition hover:bg-[#EFF6FF] hover:text-[#2563EB]"
                >
                ...
                <a
                  ...
                  role="menuitem"
                  onClick={closeMenu}
                  className="mt-1 flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-bold text-[#6B7280] transition hover:bg-[#EFF6FF] hover:text-[#1D4ED8]"
                >
