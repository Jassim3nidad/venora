    ...
    <span
      className={[
        ...
        role === "customer"
          ...
          : "bg-[#F3E8FF] text-[#7E22CE]", // purple theme for suppliers
      ].join(" ")}
    >
      {label}
    </span>
    ...
    <div className="flex flex-col gap-4">
      ...
      {messages.length === 0 ? (
        ...
        <div className="flex max-h-[480px] flex-col gap-3 overflow-y-auto pr-1">
          {messages.map((msg) => {
            const isOwn = msg.sender_id === supplierUserId;
            return (
              <div
                key={msg.id}
                className={[
              ...
              >
                ...
                <div
                  className={[
                    "max-w-[85%] rounded-2xl px-4 py-3 text-sm font-medium leading-6",
                    isOwn
                      ? "rounded-tr-sm bg-[#7E22CE] text-white" // purple theme for suppliers
      ...
      <div className="grid gap-2">
        ...
        <div className="overflow-hidden rounded-2xl border border-[#E5E7EB] bg-white shadow-sm transition-all focus-within:border-[#7E22CE] focus-within:ring-4 focus-within:ring-[#7E22CE]/10">
          <textarea
            ref={textareaRef}
            value={text}
          ...
          <div className="flex items-center justify-between border-t border-[#E5E7EB] bg-[#F9FAFB] px-3 py-2">
            ...
            <button
              ...
              className="inline-flex h-9 items-center gap-2 rounded-xl bg-[#7E22CE] px-4 text-xs font-black text-white transition hover:bg-[#6B21A8] disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isPending ? (
