...
} from "@/features/admin-settings/types/system-setting.types";
...
> = {
  ...
  marketplace: {
    title: "Marketplace",
    description: "Listing and booking limits.",
  },
  security: {
    title: "Security",
    description: "Uploads, sessions, and login protection.",
  },
  maintenance: {
    title: "Maintenance",
    description: "Platform-wide switches — changes require a reason.",
  },
};
...
export default async function AdminSettingsPage() {
  ...
  return (
    <DashboardSubPage
      ...
      description={
        canManage
          ? "Typed, validated platform configuration."
          : "You can view system settings, but changing them requires the system_settings.manage permission."
      }
    >
            ...
            <div>
              {defs.map((def) => {
                ...
                return canManage ? (
                  ...
                  <div
                    key={def.key}
                    className="flex items-center justify-between border-b border-[#f1f5f9] py-4 last:border-0"
                  >
                    <div>
