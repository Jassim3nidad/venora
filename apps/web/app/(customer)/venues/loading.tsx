  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-[#F9FAFB] text-[#111827]">
      <div className="flex min-h-0 w-full flex-1 overflow-hidden">
        ...
        <aside className="hidden h-full w-[360px] shrink-0 overflow-hidden lg:block">
          <div className="flex h-full flex-col gap-4 border-r border-[#E5E7EB] bg-white p-6">
            {/* Sidebar header */}
        ...
        <main className="h-full min-w-0 flex-1 overflow-y-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8 xl:px-12">
          <div className="flex flex-col gap-9">
            ...
            <section className="overflow-hidden rounded-[24px] border border-[#E5E7EB]/90 bg-white shadow-sm shadow-slate-200/60 p-5 sm:p-7">
