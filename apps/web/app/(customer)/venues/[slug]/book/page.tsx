...
export default async function BookVenuePage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] text-[#111827]">
      ...
      <main
        className="container"
        style={{ paddingBlock: "2rem", maxWidth: 640 }}
      >
        <h1
          style={{
        ...
        <p style={{ color: "var(--text-secondary)", marginBottom: "2rem" }}>
          Fill in your event details below. You won&apos;t be charged until the
          venue confirms.
        </p>
        ...
        >
          ...
          <div
            style={{
              ...
              background: "hsl(217 70% 47% / 0.05)",
              border: "1px solid hsl(217 70% 47% / 0.2)",
            }}
          >
            <div
              style={{
